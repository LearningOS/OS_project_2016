...
xst -ifn xst.scr
move comclk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\comclk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc comclk_exdes.ucf comclk_exdes

echo 'Running map'
map -timing -pr b comclk_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm comclk_exdes -w routed.ncd routed.vhd
cd ..
