...
static inline struct jffs2_node_frag *frag_first(struct rb_root *root)
{
	...
	// jffs2-for-transplant
	// return to_struct(node, struct jffs2_node_frag, rb);
	return to_struct(node, struct jffs2_node_frag, rb);
}
...
#define frag_next(frag) to_struct(rb_next(&(frag)->rb), struct jffs2_node_frag, rb)
#define frag_prev(frag) to_struct(rb_prev(&(frag)->rb), struct jffs2_node_frag, rb)
#define frag_parent(frag) to_struct(rb_parent(&(frag)->rb), struct jffs2_node_frag, rb)
#define frag_left(frag) to_struct((frag)->rb.rb_left, struct jffs2_node_frag, rb)
#define frag_right(frag) to_struct((frag)->rb.rb_right, struct jffs2_node_frag, rb)
#define frag_erase(frag, list) rb_erase(&frag->rb, list);

#define tn_next(tn) to_struct(rb_next(&(tn)->rb), struct jffs2_tmp_dnode_info, rb)
#define tn_prev(tn) to_struct(rb_prev(&(tn)->rb), struct jffs2_tmp_dnode_info, rb)
#define tn_parent(tn) to_struct(rb_parent(&(tn)->rb), struct jffs2_tmp_dnode_info, rb)
#define tn_left(tn) to_struct((tn)->rb.rb_left, struct jffs2_tmp_dnode_info, rb)
#define tn_right(tn) to_struct((tn)->rb.rb_right, struct jffs2_tmp_dnode_info, rb)
#define tn_erase(tn, list) rb_erase(&tn->rb, list);
#define tn_last(list) to_struct(rb_last(list), struct jffs2_tmp_dnode_info, rb)
#define tn_first(list) to_struct(rb_first(list), struct jffs2_tmp_dnode_info, rb)
