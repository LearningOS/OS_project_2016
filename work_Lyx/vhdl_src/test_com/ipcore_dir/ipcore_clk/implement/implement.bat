...
xst -ifn xst.scr
move ipcore_clk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\ipcore_clk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc ipcore_clk_exdes.ucf ipcore_clk_exdes

echo 'Running map'
map -timing -pr b ipcore_clk_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm ipcore_clk_exdes -w routed.ncd routed.vhd
cd ..
